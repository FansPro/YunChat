...
export default (props) => {
    ...
    return (
        <View style={localStyle.wrapper}>
            ...
            <TouchableOpacity style={[localStyle.tab, { backgroundColor: routeName === 'chatroom' ? '#fff' : lightBlueColor }]} onPress={() => { navigation.navigate('chatroom'); }}>
                <Text style={[localStyle.label, { color: routeName === 'chatroom' ? baseBlueColor : '#333' }]}>聊天室</Text>
            </TouchableOpacity>
